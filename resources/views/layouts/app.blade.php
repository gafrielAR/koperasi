            ...
            <div class="col-md-2">
                <div class="d-flex flex-column flex-shrink-0 p-3 bg-white" style="height: 90vh;">
                    <ul class="nav nav-pills flex-column mb-auto">
                        <li class="nav-item">
                            <a href="{{ route('admin.dashboard') }}" class="nav-link {{ Route::currentRouteName() == 'admin.dashboard' ? 'active' : 'link-dark' }}" aria-current="page">
                        ...
                        <li>
                            <a href="{{ route('admin.member') }}" class="nav-link {{ Route::currentRouteName() == 'admin.member' ? 'active' : 'link-dark' }}">
                                <svg class="bi pe-none me-2" width="16" height="16">
